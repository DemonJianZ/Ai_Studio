...
export default function AuthPage({ mode = "login" }) {
  ...
  return (
    <div className={`min-h-screen flex items-center justify-center bg-slate-950 text-white ${gradientBg}`}>
      ...
      <div className="relative w-full max-w-6xl grid grid-cols-1 lg:grid-cols-[1.05fr_1fr] gap-6 px-6">
        <div className="flex flex-col gap-6">
          <div className="hidden md:flex flex-col justify-center rounded-2xl border border-slate-800/70 bg-slate-900/50 backdrop-blur-lg p-6 shadow-2xl shadow-purple-900/40">
